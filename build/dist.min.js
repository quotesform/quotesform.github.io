...
l=a}e()}function h(a){if(!a)return"";var b=N.exec(a),c=b[1],d=b[3],e=b[2];return e&&(M.innerHTML=e.replace(/</g,"&lt;"),e="textContent"in M?M.textContent:M.innerText),c+e+d}function i(a){return a.replace(/&/g,"&amp;").replace(w,function(a){var b=a.charCodeAt(0),c=a.charCodeAt(1);return"&#"+(1024*(b-55296)+(c-56320)+65536)+";"}).replace(x,function(a){var b=a.charCodeAt(0);return 159>=b||173==b||b>=1536&&1540>=b||1807==b||6068==b||6069==b||b>=8204&&8207>=b||b>=8232&&8239>=b||b>=8288&&8303>=b||65279==b||b>=65520&&65535>=b?"&#"+b+";":a}).replace(/</g,"&lt;").replace(/>/g,"&gt;")}function j(a){var c="",d=a.split(";");return b.forEach(d,function(a){var d=a.split(":");if(2==d.length){var e=O(b.lowercase(d[0])),a=O(b.lowercase(d[1]));(("color"===e||"background-color"===e)&&(a.match(/^rgb\([0-9%,\. ]*\)$/i)||a.match(/^rgba\([0-9%,\. ]*\)$/i)||a.match(/^hsl\([0-9%,\. ]*\)$/i)||a.match(/^hsla\([0-9%,\. ]*\)$/i)||a.match(/^#[0-9a-f]{3,6}$/i)||a.match(/^[a-z]*$/i))||"text-align"===e&&("left"===a||"right"===a||"center"===a||"justify"===a)||"float"===e&&("left"===a||"right"===a||"none"===a)||("width"===e||"height"===e)&&a.match(/[0-9\.]*(px|em|rem|%)/)||"direction"===e&&a.match(/^ltr|rtl|initial|inherit$/))&&(c+=e+": "+a+";")}}),c}function k(a,b,c,d){return!("img"!==a||!b["ta-insert-video"]||"ta-insert-video"!==c&&"allowfullscreen"!==c&&"frameborder"!==c&&("contenteditable"!==c||"false"!==d))}function l(a,c){var d=!1,e=b.bind(a,a.push);return{start:function(a,f,g){a=b.lowercase(a),!d&&G[a]&&(d=a),d||H[a]!==!0||(e("<"),e(a),b.forEach(f,function(d,g){var h=b.lowercase(g),l="img"===a&&"src"===h||"background"===h;("style"===h&&""!==(d=j(d))||k(a,f,h,d)||L[h]===!0&&(I[h]!==!0||c(d,l)))&&(e(" "),e(g),e('="'),e(i(d)),e('"'))}),e(g?"/>":">"))},comment:function(a){e(a)},whitespace:function(a){e(i(a))},end:function(a){a=b.lowercase(a),d||H[a]!==!0||(e("</"),e(a),e(">")),a==d&&(d=!1)},chars:function(a){d||e(i(a))}}}var m=b.$$minErr("$sanitize"),n=/^<((?:[a-zA-Z])[\w:-]*)((?:\s+[\w:-]+(?:\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|[^>\s]+))?)*)\s*(\/?)\s*(>?)/,o=/^<\/\s*([\w:-]+)[^>]*>/,p=/([\w:-]+)(?:\s*=\s*(?:(?:"((?:[^"])*)")|(?:'((?:[^'])*)')|([^>\s]+)))?/g,q=/^</,r=/^<\//,s=/<!--(.*?)-->/g,t=/(^<!--.*?-->)/,u=/<!DOCTYPE([^>]*?)>/i,v=/<!\[CDATA\[(.*?)]]>/g,w=/[\uD800-\uDBFF][\uDC00-\uDFFF]/g,x=/([^\#-~| |!])/g,y=/^(\s+)/,z=f("area,br,col,hr,img,wbr,input"),A=f("colgroup,dd,dt,li,p,tbody,td,tfoot,th,thead,tr"),B=f("rp,rt"),C=b.extend({},B,A),D=b.extend({},A,f("address,article,aside,blockquote,caption,center,del,dir,div,dl,figure,figcaption,footer,h1,h2,h3,h4,h5,h6,header,hgroup,hr,ins,map,menu,nav,ol,pre,script,section,table,ul")),E=b.extend({},B,f("a,abbr,acronym,b,bdi,bdo,big,br,cite,code,del,dfn,em,font,i,img,ins,kbd,label,map,mark,q,ruby,rp,rt,s,samp,small,span,strike,strong,sub,sup,time,tt,u,var")),F=f("animate,animateColor,animateMotion,animateTransform,circle,defs,desc,ellipse,font-face,font-face-name,font-face-src,g,glyph,hkern,image,linearGradient,line,marker,metadata,missing-glyph,mpath,path,polygon,polyline,radialGradient,rect,set,stop,svg,switch,text,title,tspan,use"),G=f("script,style"),H=b.extend({},z,D,E,C,F),I=f("background,cite,href,longdesc,src,usemap,xlink:href"),J=f("abbr,align,alt,axis,bgcolor,border,cellpadding,cellspacing,class,clear,color,cols,colspan,compact,coords,dir,face,headers,height,hreflang,hspace,id,ismap,lang,language,nohref,nowrap,rel,rev,rows,rowspan,rules,scope,scrolling,shape,size,span,start,summary,target,title,type,valign,value,vspace,width"),K=f("accent-height,accumulate,additive,alphabetic,arabic-form,ascent,attributeName,attributeType,baseProfile,bbox,begin,by,calcMode,cap-height,class,color,color-rendering,content,cx,cy,d,dx,dy,descent,display,dur,end,fill,fill-rule,font-family,font-size,font-stretch,font-style,font-variant,font-weight,from,fx,fy,g1,g2,glyph-name,gradientUnits,hanging,height,horiz-adv-x,horiz-origin-x,ideographic,k,keyPoints,keySplines,keyTimes,lang,marker-end,marker-mid,marker-start,markerHeight,markerUnits,markerWidth,mathematical,max,min,offset,opacity,orient,origin,overline-position,overline-thickness,panose-1,path,pathLength,points,preserveAspectRatio,r,refX,refY,repeatCount,repeatDur,requiredExtensions,requiredFeatures,restart,rotate,rx,ry,slope,stemh,stemv,stop-color,stop-opacity,strikethrough-position,strikethrough-thickness,stroke,stroke-dasharray,stroke-dashoffset,stroke-linecap,stroke-linejoin,stroke-miterlimit,stroke-opacity,stroke-width,systemLanguage,target,text-anchor,to,transform,type,u1,u2,underline-position,underline-thickness,unicode,unicode-range,units-per-em,values,version,viewBox,visibility,width,widths,x,x-height,x1,x2,xlink:actuate,xlink:arcrole,xlink:role,xlink:show,xlink:title,xlink:type,xml:base,xml:lang,xml:space,xmlns,xmlns:xlink,y,y1,y2,zoomAndPan"),L=b.extend({},I,K,J),M=document.createElement("pre"),N=/^(\s*)([\s\S]*?)(\s*)$/,O=function(){return String.prototype.trim?function(a){return b.isString(a)?a.trim():a}:function(a){return b.isString(a)?a.replace(/^\s\s*/,"").replace(/\s\s*$/,""):a}}();b.module("ngSanitize",[]).provider("$sanitize",d),b.module("ngSanitize").filter("linky",["$sanitize",function(a){var c=/((ftp|https?):\/\/|(www\.)|(mailto:)?[A-Za-z0-9._%+-]+@)\S*[^\s.;,(){}<>"”’]/,d=/^mailto:/;return function(f,g){function h(a){a&&n.push(e(a))}function i(a,c){n.push("<a "),b.isDefined(g)&&n.push('target="',g,'" '),n.push('href="',a.replace(/"/g,"&quot;"),'">'),h(c),n.push("</a>")}if(!f)return f;for(var j,k,l,m=f,n=[];j=m.match(c);)k=j[0],j[2]||j[4]||(k=(j[3]?"http://":"mailto:")+k),l=j.index,h(m.substr(0,l)),i(k,j[0].replace(d,"")),m=m.substring(l+j[0].length);return h(m),a(n.join(""))}}])}(window,window.angular)}({},function(){return this}());var app=angular.module("QuotesFormApp",["ngAnimate","ngCookies","ngResource","ngRoute","ui.select","ngSanitize","textAngular"]);app.config(function($locationProvider){$locationProvider.html5Mode(!0),$locationProvider.requireBase=!0}),function(){var app=angular.module("QuotesFormApp");app.directive("ngEnter",function(){return function(scope,element,attrs){element.bind("keydown keypress",function(event){13===event.which&&(scope.$apply(function(){scope.$eval(attrs.ngEnter,{event:event})}),event.preventDefault())})}}),app.directive("ngCtrlEnter",function(){return function(scope,element,attrs){element.bind("keydown keypress",function(event){13===event.which&&event.ctrlKey&&(scope.$apply(function(){scope.$eval(attrs.ngCtrlEnter,{event:event})}),event.preventDefault())})}})}(),function(){var app=angular.module("QuotesFormApp");app.filter("toHTML",["$sce",function($sce){return function(input){return $sce.trustAsHtml(input)}}])}(),function(){function AuthorController($scope,$window,$location,Application,Remote){function searchAuthors(where){search=defaults.search,search.where=where,loadAuthors()}function hasNext(){return search.hasNext}function hasPrev(){return search.hasPrev}function nextPage(){search.hasNext&&(search.page++,search.skip=search.page*search.limit,loadAuthors())}function prevPage(){search.hasPrev&&(search.page--,search.skip=search.page*search.limit,loadAuthors())}function init(){Application.authenticate(function(err,res){return err?($location.path("login.html"),$window.location.reload(),console.error("Error on authentication "+JSON.stringify(err))):void loadAuthors()})}function save(){$scope.author.name&&Remote.saveAuthor({token:$scope.app.auth.token},$scope.author,function(res){loadAuthors(),angular.element("#input-text").focus(),$scope.author={}},function(err){})}function loadAuthors(){var params=search;params.token=$scope.app.auth.token,params.where=angular.merge(search.where,{createdBy:$scope.app.auth.user._id}),Remote.allAuthors(params,function(res){$scope.authors=res,$scope.authors&&$scope.authors.length>0&&$scope.authors.length%search.limit==0?search.hasNext=!0:search.hasNext=!1,search.page<=0?search.hasPrev=!1:search.hasPrev=!0},function(err){})}console.log("AuthorController init");var defaults={search:{page:0,order:"-_id",limit:20,skip:0,where:{},hasPrev:!1,hasNext:!1}},search=defaults.search;$scope.author={},$scope.authors=[],$scope.app=Application,$scope.save=save,$scope.nextPage=nextPage,$scope.prevPage=prevPage,$scope.hasNext=hasNext,$scope.hasPrev=hasPrev,$scope.searchAuthors=searchAuthors,init()}var app=angular.module("QuotesFormApp");app.controller("AuthorController",AuthorController),AuthorController.$inject=["$scope","$window","$location","Application","Remote"]}(),function(){function CategoryController($scope,$window,$location,Application,Remote){function hasNext(){return search.hasNext}function hasPrev(){return search.hasPrev}function nextPage(){search.hasNext&&(search.page++,search.skip=search.page*search.limit,loadCategories())}function prevPage(){search.hasPrev&&(search.page--,search.skip=search.page*search.limit,loadCategories())}function init(){Application.authenticate(function(err,res){return err?($location.path("login.html"),$window.location.reload(),console.error("Error on authentication "+JSON.stringify(err))):void loadCategories()})}function save(){$scope.category.text&&Remote.saveCategory({token:$scope.app.auth.token},$scope.category,function(res){loadCategories(),angular.element("#input-text").focus(),$scope.category={}},function(err){})}function loadCategories(){var params=search;params.token=$scope.app.auth.token,params.where=angular.merge(search.where,{createdBy:$scope.app.auth.user._id}),Remote.allCategories(params,function(res){$scope.categories=res,$scope.categories&&$scope.categories.length>0&&$scope.categories.length%search.limit==0?search.hasNext=!0:search.hasNext=!1,search.page<=0?search.hasPrev=!1:search.hasPrev=!0},function(err){})}console.log("CategoryController init");var defaults={search:{page:0,order:"-_id",limit:20,skip:0,where:{},hasPrev:!1,hasNext:!1}},search=defaults.search;$scope.category={},$scope.categories=[],$scope.app=Application,$scope.save=save,$scope.nextPage=nextPage,$scope.prevPage=prevPage,$scope.hasNext=hasNext,$scope.hasPrev=hasPrev,$scope.searchCategories=searchCategories,init()}var app=angular.module("QuotesFormApp");app.controller("CategoryController",CategoryController),CategoryController.$inject=["$scope","$window","$location","Application","Remote"]}(),function(){function DashboardController($scope,$window,$location,$sce,Application,Remote){function searchQuotes(where){search=defaults.search,search.where=where,loadQuotes()}function hasNext(){return search.hasNext}function hasPrev(){return search.hasPrev}function nextPage(){search.hasNext&&(search.page++,search.skip=search.page*search.limit,loadQuotes())}function prevPage(){search.hasPrev&&(search.page--,search.skip=search.page*search.limit,loadQuotes())}function init(){Application.authenticate(function(err,res){return err?($location.path("login.html"),$window.location.reload(),console.error("Error on authentication "+JSON.stringify(err))):(loadQuotes(),loadAuthors(),loadLanguages(),loadTags(),loadCategories(),loadUsedAuthors(),void loadUsedLanguages())})}function refreshAuthors(search){Remote.allAuthors({where:{name:{$regex:search,$options:"i"}}},function(res){$scope.authors=res},function(err){})}function save(){$scope.quote.text&&$scope.quote.author&&$scope.quote.language?Remote.saveQuote({token:$scope.app.auth.token},$scope.quote,function(res){loadQuotes(),$scope.quote.text="",$scope.error=!1,$scope.message="Successfully saved.",$scope.config.formattedInput?angular.element("#input-text1").focus():angular.element("#input-text").focus()},function(err){$scope.error=!0,$scope.message=err.data.error}):($scope.error=!0,$scope.message="Please fill all fields before save.")}function loadQuotes(){var params=search;params.token=$scope.app.auth.token,params.where=angular.merge(search.where,{createdBy:$scope.app.auth.user._id}),Remote.allQuotes(params,function(res){$scope.quotes=res,$scope.quotes&&$scope.quotes.length>0&&$scope.quotes.length%search.limit==0?search.hasNext=!0:search.hasNext=!1,search.page<=0?search.hasPrev=!1:search.hasPrev=!0},function(err){})}function loadUsedAuthors(){Remote.usedAuthorsByUser({userId:$scope.app.auth.user._id,token:$scope.app.auth.token,limit:10},function(res){$scope.usedAuthors=res},function(err){})}function loadUsedLanguages(){Remote.usedLanguagesByUser({userId:$scope.app.auth.user._id,token:$scope.app.auth.token},function(res){$scope.usedLanguages=res},function(err){})}function loadLanguages(){Remote.allLanguages({token:$scope.app.auth.token},function(res){$scope.languages=res},function(err){})}function loadTags(){Remote.allTags({token:$scope.app.auth.token},function(res){$scope.tags=res},function(err){})}function loadCategories(){Remote.allCategories({token:$scope.app.auth.token},function(res){$scope.categories=res},function(err){})}function loadAuthors(){Remote.allAuthors({token:$scope.app.auth.token},function(res){$scope.authors=res},function(err){})}console.log("DashboardController init");var defaults={search:{page:0,order:"-_id",limit:20,skip:0,where:{},hasPrev:!1,hasNext:!1}},search=defaults.search;$scope.message="",$scope.error=!1,$scope.app=Application,$scope.quote={},$scope.quotes=[],$scope.languages=[],$scope.authors=[],$scope.categories=[],$scope.tags=[],$scope.save=save,$scope.refreshAuthors=refreshAuthors,$scope.nextPage=nextPage,$scope.prevPage=prevPage,$scope.hasNext=hasNext,$scope.hasPrev=hasPrev,$scope.usedLanguages=[],$scope.usedAuthors=[],$scope.searchQuotes=searchQuotes,init()}var app=angular.module("QuotesFormApp");app.controller("DashboardController",DashboardController),DashboardController.$inject=["$scope","$window","$location","$sce","Application","Remote"]}(),function(){function HomePageController($scope,$window,$location,$sce,Application,Remote){function searchQuotes(where){search=defaults.search,search.where=where,loadQuotes()}function loadUsedAuthors(){Remote.usedAuthors({},function(res){$scope.usedAuthors=res},function(err){})}function loadUsedLanguages(){Remote.usedLanguages({},function(res){$scope.usedLanguages=res},function(err){})}function hasNext(){return search.hasNext}function hasPrev(){return search.hasPrev}function nextPage(){search.hasNext&&(search.page++,search.skip=search.page*search.limit,loadQuotes())}function prevPage(){search.hasPrev&&(search.page--,search.skip=search.page*search.limit,loadQuotes())}function loadQuotes(){var params=search;Remote.allQuotes(params,function(res){$scope.quotes=res,$scope.quotes&&$scope.quotes.length>0&&$scope.quotes.length%search.limit==0?search.hasNext=!0:search.hasNext=!1,search.page<=0?search.hasPrev=!1:search.hasPrev=!0},function(err){})}console.log("HomePageController init");var defaults={search:{page:0,order:"-_id",limit:20,skip:0,where:{},hasPrev:!1,hasNext:!1}},search=defaults.search;$scope.quotes=[],$scope.app=Application,$scope.nextPage=nextPage,$scope.prevPage=prevPage,$scope.hasNext=hasNext,$scope.hasPrev=hasPrev,$scope.usedLanguages=[],$scope.usedAuthors=[],$scope.searchQuotes=searchQuotes,loadQuotes(),loadUsedAuthors(),loadUsedLanguages()}var app=angular.module("QuotesFormApp");app.controller("HomePageController",HomePageController),HomePageController.$inject=["$scope","$window","$location","$sce","Application","Remote"]}(),function(){function LanguageController($scope,$window,$location,Application,Remote){function searchLanguages(where){search=defaults.search,search.where=where,loadLanguages()}function hasNext(){return search.hasNext}function hasPrev(){return search.hasPrev}function nextPage(){search.hasNext&&(search.page++,search.skip=search.page*search.limit,loadLanguages())}function prevPage(){search.hasPrev&&(search.page--,search.skip=search.page*search.limit,loadLanguages())}function init(){Application.authenticate(function(err,res){return err?($location.path("login.html"),$window.location.reload(),console.error("Error on authentication "+JSON.stringify(err))):void loadLanguages()})}function save(){$scope.language.text&&Remote.saveLanguage({token:$scope.app.auth.token},$scope.language,function(res){loadLanguages(),angular.element("#input-text").focus(),$scope.language={}},function(err){})}function loadLanguages(){var params=search;params.token=$scope.app.auth.token,params.where=angular.merge(search.where,{createdBy:$scope.app.auth.user._id}),Remote.allLanguages(params,function(res){$scope.languages=res,$scope.languages&&$scope.languages.length>0&&$scope.languages.length%search.limit==0?search.hasNext=!0:search.hasNext=!1,search.page<=0?search.hasPrev=!1:search.hasPrev=!0},function(err){})}console.log("LanguageController init");var defaults={search:{page:0,order:"-_id",limit:20,skip:0,where:{},hasPrev:!1,hasNext:!1}},search=defaults.search;$scope.language={},$scope.languages=[],$scope.app=Application,$scope.save=save,$scope.nextPage=nextPage,$scope.prevPage=prevPage,$scope.hasNext=hasNext,$scope.hasPrev=hasPrev,$scope.searchLanguages=searchLanguages,init()}var app=angular.module("QuotesFormApp");app.controller("LanguageController",LanguageController),LanguageController.$inject=["$scope","$window","$location","Application","Remote"]}(),function(){function LoginController($scope,$window,$location,Application){function init(){Application.authenticate(function(err,res){return err?console.error("Error on authentication "+JSON.stringify(err)):void(res&&($location.path("dashboard"),$window.location.reload()))})}function login(){$scope.user&&$scope.user.email&&$scope.user.password&&Application.login($scope.user,function(err,res){return err?console.error("Error on authentication "+JSON.stringify(err)):void(res&&($location.path("dashboard"),$window.location.reload()))})}console.log("LoginController init"),$scope.user={},$scope.app=Application,$scope.login=login,init()}var app=angular.module("QuotesFormApp");app.controller("LoginController",LoginController),LoginController.$inject=["$scope","$window","$location","Application"]}(),function(){function LogoutController($scope,$window,$location,Application){function init(){}console.log("LogoutController init"),$scope.app=Application,init()}var app=angular.module("QuotesFormApp");app.controller("LogoutController",LogoutController),LogoutController.$inject=["$scope","$window","$location","Application"]}(),function(){function NavigationController($scope,$window,$location,Application){function logout(){Application.logout(function(err,res){return err?console.error("Error on logout "+JSON.stringify(err)):void(res&&(console.log("Application logout successful"),$location.path("/logout.html"),$window.location.reload()))})}console.log("NavigationController init"),$scope.app=Application,$scope.logout=logout}var app=angular.module("QuotesFormApp");app.controller("NavigationController",NavigationController),NavigationController.$inject=["$scope","$window","$location","Application"]}(),function(){function SignupController($scope,$window,$location,Application){function signup(){console.log("signup clicked"),$scope.user.name&&$scope.user.email&&$scope.user.password&&$scope.user.password===$scope.user.repassword?Application.signup($scope.user,function(err,res){return err?console.error("Error on signup "+JSON.stringify(err)):($location.path("dashboard"),void $window.location.reload())}):console.log("Invalid input")}$scope.user={},$scope.signup=signup,$scope.app=Application}var app=angular.module("QuotesFormApp");app.controller("SignupController",SignupController),SignupController.$inject=["$scope","$window","$location","Application"]}(),function(){function TagController($scope,$window,$location,Application,Remote){function searchTags(where){search=defaults.search,search.where=where,loadTags()}function hasNext(){return search.hasNext}function hasPrev(){return search.hasPrev}function nextPage(){search.hasNext&&(search.page++,search.skip=search.page*search.limit,loadTags())}function prevPage(){search.hasPrev&&(search.page--,search.skip=search.page*search.limit,loadTags())}function init(){Application.authenticate(function(err,res){return err?($location.path("login.html"),$window.location.reload(),console.error("Error on authentication "+JSON.stringify(err))):void loadTags()})}function save(){$scope.tag.text&&Remote.saveTag({token:$scope.app.auth.token},$scope.tag,function(res){loadTags(),angular.element("#input-text").focus(),$scope.tag={}},function(err){})}function loadTags(){var params=search;params.token=$scope.app.auth.token,params.where=angular.merge(search.where,{createdBy:$scope.app.auth.user._id}),Remote.allTags(params,function(res){$scope.tags=res,$scope.tags&&$scope.tags.length>0&&$scope.tags.length%search.limit==0?search.hasNext=!0:search.hasNext=!1,search.page<=0?search.hasPrev=!1:search.hasPrev=!0},function(err){})}console.log("TagController init");var defaults={search:{page:0,order:"-_id",limit:20,skip:0,where:{},hasPrev:!1,hasNext:!1}},search=defaults.search;$scope.tag={},$scope.tags=[],$scope.app=Application,$scope.save=save,$scope.nextPage=nextPage,$scope.prevPage=prevPage,$scope.hasNext=hasNext,$scope.hasPrev=hasPrev,$scope.searchTags=searchTags,init()}var app=angular.module("QuotesFormApp");app.controller("TagController",TagController),TagController.$inject=["$scope","$window","$location","Application","Remote"]}(),function(){function Application($location,$cookies,Remote){function logout(cb){$cookies.remove(KEY_AUTH),auth=null,cb&&cb(null,{success:"Application logout successful"})}function processAuthResult(res,cb){res&&res.token&&(console.log("authenticate success ! "+JSON.stringify(res)),$cookies.putObject("auth",res),cb&&cb(null,res))}function login(user,cb){Remote.login({},user,function(res){processAuthResult(res,cb)},function(err){cb&&cb(err,null)})}function signup(user,cb){Remote.signup({},user,function(res){processAuthResult(res,cb)},function(err){cb&&cb(err,null)})}function authenticate(cb){console.log("Application authenticate called"),auth&&auth.token?Remote.authenticate({token:auth.token},function(res){processAuthResult(res,cb)},function(err){cb&&cb(err,null)}):cb&&cb({error:"Please login"},null)}var KEY_AUTH="auth",auth=$cookies.getObject(KEY_AUTH),host=$location.host(),app={self:this,auth:auth,host:host,signup:signup,authenticate:authenticate,login:login,logout:logout};return auth&&processAuthResult(auth),app}var app=angular.module("QuotesFormApp");app.factory("Application",Application),Application.$inject=["$location","$cookies","Remote"]}(),function(){function Remote($resource,$location){var host=$location.host(),server="http://api.localhost:3000";return server="localhost"===host?"http://api.localhost:3000":"http://api.quotesform.com",console.log("Remote : host = "+host+" server = "+server),$resource(server,{},{signup:{method:"POST",url:server+"/signup"},authenticate:{method:"GET",url:server+"/authenticate"},login:{method:"POST",url:server+"/login"},saveLanguage:{method:"POST",url:server+"/language"},allLanguages:{method:"GET",isArray:!0,url:server+"/language"},usedLanguages:{method:"GET",isArray:!0,url:server+"/language/used"},usedLanguagesByUser:{method:"GET",isArray:!0,url:server+"/language/used/by/:userId"},createdLanguagesByUser:{method:"GET",isArray:!0,url:server+"/language/created/by/:userId"},saveCategory:{method:"POST",url:server+"/category"},allCategories:{method:"GET",isArray:!0,url:server+"/category"},saveTag:{method:"POST",url:server+"/tag"},allTags:{method:"GET",isArray:!0,url:server+"/tag"},saveAuthor:{method:"POST",url:server+"/author"},allAuthors:{method:"GET",isArray:!0,url:server+"/author"},usedAuthors:{method:"GET",isArray:!0,url:server+"/author/used"},usedAuthorsByUser:{method:"GET",isArray:!0,url:server+"/author/used/by/:userId"},createdAuthorsByUser:{method:"GET",isArray:!0,url:server+"/author/created/by/:userId"},saveQuote:{method:"POST",url:server+"/quote"},allQuotes:{method:"GET",isArray:!0,url:server+"/quote"}})}var app=angular.module("QuotesFormApp");app.factory("Remote",Remote),Remote.$inject=["$resource","$location"]}();